...
_CAP_MIN_EDITION = {
    ...
    "lang_packs":     "pro",    # non-free language packs (he + English always free)
...
def _source_present(cap: str) -> bool:
    ...
    if cap in ("llm_classifier", "learning"):
        # The enhancement layer reports its own availability.
        try:
            from . import _pro
            return bool(getattr(_pro, "AVAILABLE", False))
        except Exception:
            return False
    needed_module = {
